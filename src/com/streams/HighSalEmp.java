...
public class HighSalEmp {
	...
	public static void main(String[] args) {
		...
		// highest salary from emp object
		Optional<Emp> highSal = empobj.stream().max(Comparator.comparingLong(Emp::getSal));
		System.out.println(highSal.get().getName() + "::" + highSal.get().getSal());
	}
